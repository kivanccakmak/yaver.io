...
**Important**: Files 2–4 are gitignored (generated by `expo prebuild`) but persist locally. Always verify all four match before deploying to TestFlight or Google Play. Mismatches cause version confusion in App Store Connect.
