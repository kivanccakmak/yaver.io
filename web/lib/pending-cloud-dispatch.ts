  ...
  return {
    ...
    output: [
      ...
      normalized.targetDeviceId
        ? "Yaver will dispatch it from this browser after the target machine connects."
        : "Yaver will dispatch it from this browser after the target machine is assigned and connects.",
