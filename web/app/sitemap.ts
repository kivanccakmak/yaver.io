...
const staticRoutes: StaticRoute[] = [
  ...
  { path: "/remote-ai-coding-agent", changeFrequency: "monthly", priority: 0.9 },
  ...
  { path: "/docs/testing", changeFrequency: "monthly", priority: 0.6 },
  { path: "/docs/yaver-protocol", changeFrequency: "monthly", priority: 0.6 },
  { path: "/docs/unity", changeFrequency: "monthly", priority: 0.5 },
  ...
  { path: "/manuals/windows-ssh-coding-box", changeFrequency: "monthly", priority: 0.5 },
