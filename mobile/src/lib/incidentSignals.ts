...
//
// MOBILE TWIN. Byte-identical to web/lib/incidentSignals.ts below this header,
// pinned by incidentSignals.test.ts. See that file for why: every incident
// already carries `code`, /incidents is already fetched here
// (quic.ts:9287), and the codes were simply never read.
