...
//
// KEEP IN SYNC with web/lib/capabilityGap.ts — byte-identical below the header
// comment, pinned by capabilityGap.test.mts. Two surfaces, one renderer, or
// "named on one surface only" ships again.
