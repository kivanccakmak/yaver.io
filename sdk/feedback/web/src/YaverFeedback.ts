    ...
    const bundle: FeedbackBundle = {
      metadata: {
        ...
        project: {
          ...
          surfaces: YaverFeedback.config?.surfaces,
          stack: YaverFeedback.config?.stack,
          stacks: YaverFeedback.config?.stacks,
          testSurfaces: YaverFeedback.config?.testSurfaces,
          feedbackSdk: YaverFeedback.config?.feedbackSdk,
          feedbackTransport: YaverFeedback.config?.feedbackTransport,
          voiceCapabilities: YaverFeedback.config?.voiceCapabilities,
          sttProvider: YaverFeedback.config?.sttProvider,
          ttsProvider: YaverFeedback.config?.ttsProvider,
