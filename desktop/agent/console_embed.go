...
// consoleFallbackHTML is intentionally inert. The former support-code redeem
// surface was non-owner access and has been removed.
const consoleFallbackHTML = `<!doctype html><html lang="en"><head>
<meta charset="utf-8"><title>Yaver Console</title>
<meta name="viewport" content="width=device-width,initial-scale=1">
<style>body{font-family:system-ui;background:#09090b;color:#e4e4e7;padding:2rem;max-width:42rem;margin:auto}a{color:#818cf8}</style>
</head><body><h1>Yaver Console</h1><p>The embedded console bundle is not installed.</p>
<p><a href="https://yaver.io/dashboard">Open the owner dashboard</a>.</p></body></html>`
