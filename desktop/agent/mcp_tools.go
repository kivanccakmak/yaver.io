...
func (s *HTTPServer) getMCPToolsList() interface{} {
	...
	locationTools := []map[string]interface{}{
		{"name": "ev_charging", "description": "Find EV charging stations nearby (OpenChargeMap, free, no API key).", "inputSchema": map[string]interface{}{"type": "object", "required": []string{"lat", "lon"}, "properties": map[string]interface{}{"lat": map[string]interface{}{"type": "number", "description": "Latitude"}, "lon": map[string]interface{}{"type": "number", "description": "Longitude"}, "radius": map[string]interface{}{"type": "integer", "description": "Search radius in km (default: 10)"}, "connector_type": map[string]interface{}{"type": "string", "description": "Connector type filter"}}}},
