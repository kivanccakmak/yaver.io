...
var replCatalog = []replCommand{
	...
	{"wrap claude", "Launch Claude Code here (yolo + yaver MCP attached)"},
	{"wrap codex", "Launch OpenAI Codex here (yolo + yaver MCP attached)"},
	{"wrap opencode", "Launch opencode here (yolo + yaver MCP attached)"},
