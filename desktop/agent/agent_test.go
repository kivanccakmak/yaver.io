...
func TestMCPInitializeAndToolsList(t *testing.T) {
	...
	for _, expected := range []string{"create_task", "list_tasks", "get_task", "stop_task", "machine_doctor", "machine_roles_doctor", "machine_roles", "machine_repair", "agent_machine_inventory", "agent_graph_start", "agent_graph_list", "agent_graph_show", "agent_graph_stop", "mobile_hermes_doctor"} {
