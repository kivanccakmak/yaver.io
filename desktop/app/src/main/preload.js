...
contextBridge.exposeInMainWorld('yaver', {
  ...
  getTaskQuestion: (id) => ipcRenderer.invoke('agent-request', 'GET', `/tasks/${id}/question`),
  answerTaskQuestion: (id, questionId, answer) => ipcRenderer.invoke('agent-request', 'POST', `/tasks/${id}/answer`, { questionId, answer }),
  getTaskRunnerControls: (id) => ipcRenderer.invoke('agent-request', 'GET', `/tasks/${id}/control`),
  applyTaskRunnerControl: (id, data) => ipcRenderer.invoke('agent-request', 'POST', `/tasks/${id}/control`, data),
